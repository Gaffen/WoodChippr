...
gulp.task("scripts", function() {
  ...
  if(process.env.USE_MODERNIZR === "true") {

    var moduleSettingsRules = [];

    if (options.hasOwnProperty('module') && options.module.hasOwnProperty('rules')) {

      moduleSettingsRules = moduleSettingsRules.concat(options.module.rules, modernizrConfig.module.rules);
  ...
  if(process.env.NODE_ENV === "development"){
    ...
    Object.assign(options, {plugins:[new webpack.optimize.UglifyJsPlugin()]});
  }
